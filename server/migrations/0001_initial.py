# Generated by Django 2.2.3 on 2019-09-20 21:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_code', models.CharField(blank=True, max_length=127, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('title', django.contrib.postgres.fields.jsonb.JSONField(default=server.models.multilanguage)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('name', django.contrib.postgres.fields.jsonb.JSONField(default=server.models.multilanguage)),
                ('value', django.contrib.postgres.fields.jsonb.JSONField(default=server.models.feature_value)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', django.contrib.postgres.fields.jsonb.JSONField(default=server.models.multilanguage)),
                ('type', models.CharField(blank=True, choices=[(1, 'video'), (2, 'image'), (3, 'audio')], max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('box', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server.Box')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permalink', models.URLField(blank=True, null=True)),
                ('gender', models.BooleanField(blank=True, null=True)),
                ('short_description', django.contrib.postgres.fields.jsonb.JSONField(default=server.models.multilanguage)),
                ('description', django.contrib.postgres.fields.jsonb.JSONField(default=server.models.multilanguage)),
                ('location', models.CharField(blank=True, max_length=65, null=True)),
                ('usage_condition', django.contrib.postgres.fields.jsonb.JSONField(default=server.models.multilanguage)),
                ...
                ('box', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='server.Box')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date2', django.contrib.postgres.fields.ranges.DateTimeRangeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('deleted', models.DateTimeField(editable=False, null=True)),
                ('available_count', models.BigIntegerField(blank=True, default=0, verbose_name='Available count')),
                ('available_count_for_sale', models.BigIntegerField(blank=True, default=0, verbose_name='Available count for sale')),
                ...
                ('discount_price_percent', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Discount price percent')),
                ('discount_vip_price_percent', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Discount vip price percent')),
                ('default', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('box', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='server.Box')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server.Category')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='storage_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='storage_deleted_by', to=settings.AUTH_USER_MODEL, verbose_name='Deleted by')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server.Product')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='storage_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
            ],
            options={
                'db_table': 'storage',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('deleted', models.DateTimeField(editable=False, null=True)),
                ('title', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=server.models.multilanguage, null=True)),
                ...
                ('storage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server.Storage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('not_accepted_products', models.ManyToManyField(blank=True, related_name='special_offer_not_accepted_products', to='server.Storage')),
                ('product', models.ManyToManyField(blank=True, related_name='special_offer_products', to='server.Storage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='server.Media')),
        ...
        migrations.AddField(
            model_name='factor',
            name='products',
            field=models.ManyToManyField(through='server.FactorProduct', to='server.Product'),
        ),
        migrations.AddField(
            model_name='factor',
            name='suspended_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='factor_suspended_by', to=settings.AUTH_USER_MODEL, verbose_name='Suspended by'),
        ),
        migrations.AddField(
            model_name='factor',
            name='updated_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='factor_product_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by'),
        ),
        migrations.AddField(
            model_name='factor',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=255)),
                ('blog_post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='server.BlogPost')),
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='server.Product')),
                ('reply', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='server.Comment')),
        ...
        migrations.AddField(
            model_name='blogpost',
            name='updated_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_post_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by'),
        ),
        migrations.AddField(
            model_name='blog',
            name='box',
        ...
        migrations.AddField(
            model_name='basket',
            name='products',
            field=models.ManyToManyField(through='server.BasketProduct', to='server.Storage'),
        ),
        migrations.AddField(
            model_name='basket',
            name='updated_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='basket_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Updated by'),
        ),
        migrations.AddField(
            model_name='basket',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='server.Media')),
                ('storage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='server.Storage')),
            ],
            options={
                'db_table': 'ad',
            },
        ...
        migrations.AddIndex(
            model_name='product',
            index=django.contrib.postgres.indexes.GinIndex(fields=['name'], name='product_name_cdbbaa_gin'),
        ),
    ]
